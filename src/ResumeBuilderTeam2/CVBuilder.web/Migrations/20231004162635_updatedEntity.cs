    ...
    public partial class updatedEntity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Admin", "Add User", new DateTime(2023, 10, 4, 16, 26, 35, 146, DateTimeKind.Utc).AddTicks(1771), new DateTime(2023, 10, 4, 16, 26, 35, 146, DateTimeKind.Utc).AddTicks(1776) },
                    { 2, "Admin", "Edit User", new DateTime(2023, 10, 4, 16, 26, 35, 146, DateTimeKind.Utc).AddTicks(1781), new DateTime(2023, 10, 4, 16, 26, 35, 146, DateTimeKind.Utc).AddTicks(1783) },
                    { 3, "Admin", "Delete User", new DateTime(2023, 10, 4, 16, 26, 35, 146, DateTimeKind.Utc).AddTicks(1787), new DateTime(2023, 10, 4, 16, 26, 35, 146, DateTimeKind.Utc).AddTicks(1789) },
                    { 4, "Admin", "Get User", new DateTime(2023, 10, 4, 16, 26, 35, 146, DateTimeKind.Utc).AddTicks(1792), new DateTime(2023, 10, 4, 16, 26, 35, 146, DateTimeKind.Utc).AddTicks(1793) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("a41d000c-5fb1-47b7-addf-f0c73faebeea"), 0, null, "d311e214-84a5-4b01-a551-675c4a48b77f", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", true, "Jhon", "Deo", false, null, "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAIAAYagAAAAEC/bzJ7fZO3ChBujpsO8E3c9NNPJxV0mkmibWmQTizAh8OxeFDXICXt3g60D0X0JlA==", null, false, null, "00000000-0000-0000-0000-000000000000", false, "admin@gmail.com" });
